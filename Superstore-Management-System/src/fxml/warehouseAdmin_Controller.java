...
public class warehouseAdmin_Controller {
	...
	/**
	 * used to set up the page initially
	 * used by caller controller
	 * @param Room
	 * @param application
	...
	/**
	 * default setup page for the page
	 * called by previous caller controller
	 */
	 ...
	 * used to open categories / subcategoreis
	 */
	 ...
	 * used to delete category/subCategory of the product
	 */
	...
	/**
	 * event handler for the other warehouses button 
	 * used to open other warehouses page and call its setapp method
	 */
